...
exports.InitDb1712167953480 = void 0;
class InitDb1712167953480 {
    constructor() {
        this.name = 'InitDb1712167953480';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "vrienden" ("friendship_id" SERIAL NOT NULL, CONSTRAINT "PK_05c6e8af1e6e08bdfa38ceddc88" PRIMARY KEY ("friendship_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "friendship" ("user_id" integer NOT NULL, "friend_id" integer NOT NULL, CONSTRAINT "PK_8ad5e55bcae38d0bca5cd7d0b38" PRIMARY KEY ("user_id", "friend_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "friendship" ADD CONSTRAINT "FK_8885973a7c761a7f8fc0fc673f6" FOREIGN KEY ("user_id") REFERENCES "vrienden"("friendship_id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP TABLE "vrienden"`);
        await queryRunner.query(`DROP TABLE "user"`);
    }
}
exports.InitDb1712167953480 = InitDb1712167953480;
