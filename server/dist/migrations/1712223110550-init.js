...
exports.Init1712223110550 = void 0;
class Init1712223110550 {
    constructor() {
        this.name = 'Init1712223110550';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "user_friends" ("user_id" integer NOT NULL, "userUserid" integer NOT NULL, CONSTRAINT "PK_ab6ae0a60262f8523d7d9a4da3c" PRIMARY KEY ("user_id", "userUserid"))`);
...
exports.Init1712223110550 = Init1712223110550;
